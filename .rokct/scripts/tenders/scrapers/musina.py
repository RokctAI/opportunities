        ...
        for link in soup.find_all('a', href=True):
            ...
            if rfq_match:
                ...
                if date_match:
                    ...
                    # Fallback: extract date from URL structure (e.g. wp-content/uploads/2025/11/...)
                    url_date = re.search(r'/uploads/(\d{4})/(\d{2})/', url)
                    if url_date:
                        year, month = url_date.group(1), url_date.group(2)
