...
BID NO: WMM-LM 31/07/26/03 RSB
CLOSING DATE & TIME: 28 August 2026 @12h00
COMPULSORY BID MEETING: N/A
Documents to be emailed to tenders.scm@winniemmlm.gov.za
Issued and Prepared by:
Winnie Madikizela Mandela Local Municipality
P.O. Box 12
Bizana
4800
The Municipal Manager: L. Mahlaka
Contact Person: N. Mafumbatha
Tel: 039 2510 230
...
WINNIE MADIKIZELA MANDELA LOCAL MUNICIPALITY
ADVERT
No PROJECT NAME CONTRACT CLOSING DATE
NUMBER
1 Spatial Redefinition of settlement Boundaries WMM-LM 31/07/26/03 RSB 28 August 2026 @12h00
Bids are hereby invited from suitably qualified and accredited service providers who are interested to submit their tender responses for
...
• Fully completed and signed bid documents MBD1, MBD4, MBD6.1, MBD 8 and MBD 9
...
• In case of a joint venture, valid Tax Pin printouts of all partners should be submitted as well as a signed agreement by all
...
Closing Date: All tenders must be emailed to tenders.scm@winniemmlm.gov.za by no later than the date and time stated above after
which they will be opened.
The municipality will only consider bids submitted on the original bid documentation provided by the municipality. All tenders must
be clearly marked the Name of the project and Reference number indicated above. Failure to do so, your tender may not be
considered. Any unsigned alterations in the BOQ/Quotation/Pricing schedule to the tender document shall render the
submission invalid. Bidders with a turnover of more than R2 300 000.00 on taxable supplies should be registered as VAT Vendor
...
Email: mafumbathan@winniemmlm.gov.za Supply Chain Management related enquiries, please contact Mr Z. Khala at 079 886 0942
email: khalaz@winniemmlm.gov.za / info.scm@winniemmlm.gov.za during working hours
……………………………………
Mr. L. Mahlaka
Municipal Manager
...
REQUIREMENTS
TENDERS.SCM@WINNIEMMLM.GOV.ZA for tenders above R300 000 inclusive of VAT
OR
QUOTES.SCM@WINNIEMMLM.GOV.ZA for quotations below R300 000 but above R30 000 inclusive of VAT
...
AFRICA FOR THE GOODS Yes No GOODS /SERVICES Yes No
...
6 of 43
INTRODUCTION
Winnie Madikizela-Mandela Local Municipality is mandated to ensure sustainable spatial planning, equitable service
delivery, effective land administration, and evidence-based development planning in terms of applicable legislation
and municipal planning frameworks.
The Municipality has identified the need to undertake a comprehensive review, spatial redefinition, and update of
settlement boundaries within its jurisdiction. Existing settlement boundary information is outdated, inconsistently
defined, and in some instances not aligned with current settlement growth patterns, land use dynamics, administrative
records, traditional settlement expansion, infrastructure provision, and spatial planning instruments.
The project seeks to establish accurate, standardized, and GIS-compliant settlement boundaries to support municipal
planning, infrastructure development, service delivery planning, spatial analysis, disaster management, Integrated
Development Planning (IDP), Spatial Development Framework (SDF) implementation, revenue planning, and other
municipal functions.
The Municipality therefore invites suitably qualified and experienced service providers to undertake the Spatial
Redefinition and Update of Settlement Boundaries project.
PURPOSE OF THE PROJECT
The purpose of this project is to appoint a qualified and experienced service provider to spatially redefine, verify,
standardize, and update settlement boundaries within the municipal jurisdiction and develop a GIS-compliant spatial
dataset and associated settlement boundary register for municipal planning and administrative purposes.
OBJECTIVES OF THE PROJECT
The objectives of the project are to:
• Review existing settlement boundary data and related spatial information.
• Identify and verify all settlements within the municipal jurisdiction.
• Redefine and update settlement boundaries using GIS and spatial analysis techniques.
• Align settlement boundaries with current land use patterns, cadastral information, traditional settlement
extents, infrastructure networks, and administrative records.
• Rectify the names of settlements that are incorrectly named.
• Develop standardized GIS datasets and metadata for all settlements.
• Improve the accuracy and reliability of settlement information for municipal planning and decision-making.
• Establish a defensible and auditable spatial settlement boundary database for the Municipality.
• Produce updated maps, reports, and spatial layers compatible with the municipal GIS environment.
ROLE OF A SERVICE PROVIDER
The successful service provider must assist the WMMLM with Spatial Redefinition of Settlement Boundaries
SCOPE OF WORK
The appointed service provider will be required to undertake, but not limited to, the following activities:
Project Inception
• Attend inception and stakeholder meetings.
• Develop and submit a detailed project implementation plan and methodology.

7 of 43
• Identify required datasets, stakeholders, and data gaps.
Data Collection and Review
Review and assess available spatial and non-spatial datasets, including:
• Existing settlement boundary datasets
• Cadastral data
• Aerial imagery and orthophotos
• Land use data
• Traditional authority information
• Census and demographic data
• Infrastructure and service delivery information
• Existing municipal planning datasets
Spatial Redefinition and Verification
• Conduct spatial analysis and settlement boundary delineation.
• Identify settlement expansion and spatial growth trends.
• Verify settlement extents through desktop analysis and field verification where required.
• Redefine settlement boundaries using approved GIS methodologies.
• Resolve overlaps, duplication, and inconsistencies in existing datasets.
• Ensure logical and defensible settlement delineation.
• Verify settlement names.
Stakeholder Consultation and Validation
• Engage relevant municipal departments and stakeholders.
• Facilitate validation workshops.
• Incorporate comments and corrections into the final datasets.
GIS Database Development
• Develop GIS-compatible settlement boundary datasets.
• Ensure data is compatible with the Municipality’s GIS environment.
• Create and populate metadata for all spatial datasets.
• Standardize naming conventions and attribute structures.
Mapping and Reporting
Prepare and submit:
• Settlement boundary maps
• GIS shapefiles/geodatabase
• Technical methodology report
• Spatial analysis report
• Final settlement boundary register
• Metadata documentation
Capacity Building and Handover
• Conduct knowledge transfer sessions with municipal officials.
• Submit all editable GIS files and associated documentation.
• Provide a final project handover report.
PROJECT DURATION & TIMEFRAMES
The project time frame will be Six months from the date of appointment of the service provider. The municipality will
draft an agreement to be signed by both parties (a successful service provider and the municipality).

8 of 43
The project proposal must contain the following:
• Clear project methodology and planning process to be followed
• Comprehensive company profile and contact person to be responsible for the project, Names,
qualifications, registrations and experience of all professionals that will be part of the project and
further indicate if some consortium will be formed
• Clear time frame for the project
• Clear project budget aligned to the tasks or activities
PROJECT DELIVERABLES
At the end of the project, the service provider will be required to submit the following:
• Inception Report
• Draft settlement boundary dataset and draft maps
• Stakeholder Consultation Report
• Final Settlement Boundary Datasets and final maps
• Metadata Documentation
• Final Technical Report
• Handover Package.
•
STAKEHOLDERS CONSULTATION
Through consultation between the service provider and the municipality, the service provider will provide technical
guidance, while the municipality will be responsible for undertaking the stakeholder consultation, as it is a vital
component when establishing a Project Steering Committee.
PROJECT MANAGEMENT
In case where the appointed service provider appoints the services of other consultants or sub- contractors, the
appointed service provider will take full responsibility of the work of the sub- contractors. The project is to be
coordinated and managed by an Operational Team comprising the officials from the municipality as well as the
appointed service provider. The Project Manager will act as a liaison party between the service provider and the
project steering committee.
PROJECT TEAM COMPOSITION
The proposed project team should include:
• GIS Specialist / GIS Analyst
• Spatial Planner
• GIS Technician / Data Capturer
•
REQUIRED EXPERTISE AND EXPERIENCE
The service provider must demonstrate:
• Proven experience in GIS and spatial planning projects.
• Experience in settlement mapping and boundary delineation.
• Experience working with municipalities or government institutions.
• Availability of qualified GIS professionals, planners, and spatial analysts.
• Experience in GIS database development and spatial data management.
• Knowledge of South African spatial planning legislation and standards.
EDUCATION AND CAPACITY BUILDING

9 of 43
The appointed service provider will be required to transfer skills and share knowledge on this nature of the exercise
with the relevant officials and management from the municipality for the duration of the project.
REPORTING MECHANISM
It is expected that progress reports be presented monthly to the Project Steering Committee for comments and inputs.
The Project Manager has the right to change frequency of reporting as and when necessary. Reporting process will
be in both written and presentation format on the following phases of the project:
• Inception report
• Draft Settlement Boundaries and Maps
• Final Settlement Boundaries and Maps
• Capacity building and skills transfer report
• Final Technical report
REFERENCE MATERIALS
The project must align with applicable legislation, policies, and frameworks, including but not limited to:
...
• Applicable GIS and spatial data standards
• Municipal GIS Strategy and Policies
• South African Geographical Names Council Act, 1998 (Act No. 118 of 1998)
EVALUATION PROCESS
Received Responsive Proposals will be evaluated based on the following criteria;
• A proof of Professional Indemnity,
• Proposed Project Team,
• Their CV’s and proof of professional registration with relevant professional bodies.
The bid will be evaluated in two stages namely: Functionality and Price and Specific Goals Bidders who scores less
than 70% on stage 1 will not be evaluated further. Only bidders who score 70 % or more would be evaluated further
and therefore eligible for the award.
...
Functionality 100
• Previous References 40
• Professional body registration, Expertise, and 40
Experience of proposed team
• Methodology 20
First Stage - Evaluation of Functionality
Functionality criteria Weight Points Scoring
Methodology 20 Work
Detailed Gantt Chart and project implementation plan. programme,
Methodology and approach are fully adequate to meet the plan and
requirements of the assignment relating to the allocation of
deliverables required by these terms of reference. resources and
tasks
Expertise, and Experience of proposed team : 40 Experience of Points
Appropriate expertise of the suitably qualified human Registered
resources, both in respect of principles and/or other staff. Professional
• Team leader: Professional Planner 5 years or more 40
• Team Member: GIS specialist 3-4 years or 20
• Proof of registration with professional bodies i.e more
SACPLAN (professional or technical). Relevant
information must be contained in
curriculum/curricula vitae submitted with the
tender together with proof of professional
registration of project team members.
Previous Experience with related projects : 40 Number of Points
Number of comparable projects completed by the service projects
provider. The schedule of previous related projects 2 similar projects 40
describing the projects Appointment Letters and
Reference Letters for each project must be submitted with
the tender.
1 similar projects 30
Reference letters must not be more than 3 Months Old
Total 100
Table 2 – Price and B-BBEE
...
6.1 No tender will be considered unless emailed to Winnie Madikizela Mandela Municipality on tenders.scm@winniemmlm.gov.za.
6.2 Any portion of the tender document not completed will be interpreted as ‘not applicable’. Notwithstanding the
foregoing, failure to complete any compulsory portion of the tender document may result in the tender being
...
event of a number of items being offered), and municipality is not obliged to accept the lowest or any tender;
...
writing.
6.7 A Tenderer may request in writing, after the closing date, that the tender offer be withdrawn. Such withdrawal
...
{Authority to Sign Bid Document on page 37 to be completed};
6.10.2 by a registered close corporation may not be considered unless accompanied by written authority from all the
members of the close corporation authorizing the tender to be made and the signatory to sign the tender on
the close corporation’s behalf (pg 37)

12 of 43
Authority to Sign Bid Document on page 37 to be completed};
6.10.3 by a partnership/consortium/joint venture may not be considered unless accompanied by written from all
parties to the partnership/consortium/joint venture authorising the tender to be made and the signatory to sign
...
a period of 90 days from the closing date or for such extended period as may be applicable.
...
6.12.5 In the event that an appeal in terms of the Systems Act 32 of 2000, is received, the validity period of the tender
...
it will cause the bid to be invalid. Any point of difficulty or doubt must be cleared with the municipality.
Should any query be found to be of any significance, the municipality will inform all bidders accordingly.
6.14 Tax clearance
6.14.1 No award shall be made to a person whose tax matters have not been declared to be in order by the South
African Revenue Service (SARS).
6.14.2 Tenderers are therefore required to obtain a valid Tax Clearance Certificate from the local SARS office where
...
1.17 “Local content” means that portion of the tender price, which is not included in the imported
...
1.25 “Supplier” means the successful bidder who is awarded the contract to maintain and administer
...
(c) if the supplier, in the judgement of the purchaser, has engaged in corrupt or fraudulent practices in competing
...
Page 27 of 38
3.15.5 Failure on the part of a tenderer to submit proof or documentation required in terms of
...
3.15.6 The organ of state reserves the right to require of a tenderer, either before a tender is
...
3.16 DEFINITIONS
1. “tender” means a written offer in the form determined by an organ of state in response
...
1. “price” means an amount of money tendered for goods or services, and
includes all applicable taxes less all unconditional discounts;
1. “rand value” means the total estimated value of a contract in Rand, calculated at the
time of bid invitation, and includes all applicable taxes;
1. “tender for income-generating contracts” means a written offer in the form
...
1. “the Act” means the Preferential Procurement Policy Framework Act, 2000 (Act No.
5 of 2000).
3.17 FORMULAE FOR PROCUREMENT OF GOODS AND SERVICES
...
3.18 POINTS AWARDED FOR SPECIFIC GOALS
...
• In cases where organs of state intend to use Regulation 3(2) of the Regulations, which
...
• an invitation for tender for income-generating contracts, that either the 80/20
...
• any other invitation for tender, that either the 80/20 or 90/10 preference point
...
3 Partnership/Joint Venture / Consortium
4 One-person business/sole propriety
5 Close corporation
6 Public Company
7 Personal Liability Company
8 (Pty) Limited
9 Non-Profit Company
10 State Owned Company
[TICK APPLICABLE BOX]

Page 30 of 38
• I, the undersigned, who is duly authorised to do so on behalf of the company/firm,
certify that the points claimed, based on the specific goals as advised in the tender,
qualifies the company/ firm for the preference(s) shown and I acknowledge that:
3 The information furnished is true and correct;
4 The preference points claimed are in accordance with the General Conditions as
indicated in paragraph 1 of this form;
5 In the event of a contract being awarded as a result of points claimed as shown
in paragraphs 1.4 and 4.2, the contractor may be required to furnish documentary
proof to the satisfaction of the organ of state that the claims are correct;
6 If the specific goals have been claimed or obtained on a fraudulent basis or any
of the conditions of contract have not been fulfilled, the organ of state may, in
addition to any other remedy it may have –
6.2 disqualify the person from the tendering process;
6.3 recover costs, losses or damages it has incurred or suffered as a
result of that person’s conduct;
6.4 cancel the contract and claim any damages which it has suffered
as a result of having to make less favourable arrangements due
to such cancellation;
6.5 recommend that the tenderer or contractor, its shareholders and
directors, or only the shareholders and directors who acted on a
fraudulent basis, be restricted from obtaining business from any
organ of state for a period not exceeding 10 years, after the audi
alteram partem (hear the other side) rule has been applied; and
6.6 forward the matter for criminal prosecution, if deemed necessary.
……………………………………….
...
CERTIFICATION
I, THE UNDERSIGNED (FULL NAMES) ………….…………………………….……
CERTIFY THAT THE INFORMATION FURNISHED ON
THIS DECLARATION FORM TRUE AND CORRECT.
...
Page 37 of 38
AUTHORITY TO SIGN BID DOCUMENT RESOLUTION BY DIRECTORS / MEMBERS:
Resolution for completion by Directors (if the Bidder is a (Pty) Ltd or Ltd) or Members (if the Bidder is
a CC)
NAME OF TENDERER:
Meeting held at
(Place)
...
31/07/26/03 RSB: Spatial Redefinition of Settlement Boundaries
...
Winnie Madikizela-Mandela Local Municipality Individual bid documents will have the typical bid check list as an
attachment. This list is to assist all bidders to submit complete bids.
Tick
...
- municipal billing clearance certificate (and a declaration letter by the bidder)
