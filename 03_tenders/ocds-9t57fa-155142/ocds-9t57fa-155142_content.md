...
RFQ Number: 4415/26
Appointment of service provider to conduct penetration and vulnerability
assessments tests bi-annually.
Closing Date and Time: 15 May 2026 at 11h00
...
1.1 Item 1: Appointment of service provider to conduct penetration and vulnerability assessments tests bi-annually.
...
Template: Specifications / Terms of Reference Annexure H
Annexure H
...
Template: Specifications / Terms of Reference Annexure H
1 DESCRIPTION
South African Weather Service is seeking for a supplier to supply bi-annual information security gap closure
project (penetration testing, vulnerability assessments).
2 INTRODUCTION
...
South African society: a combination of both public goods and commercial services. The organization plays a
vital role in South African public life, not just as a provider of key services, but also in empowering citizens to
adapt to the effects of the ever-changing weather.
3 BACKGROUND
The ICT is required to perform a penetration test assessment bi-annually through implementation of
information security gap closure project. This is in response to the evolving landscape of information and
cyber security. To identify security gaps and implement remedial actions before threat actors exploit them.
The project will encompass various categories, each requiring strategic planning, solution implementation,
mitigate risks, and ensure regulatory compliance.
To successfully achieve its operational objective, and support these strategic objectives, the ICT team needs
to ensure the IT environment and SAWS data is protected, and all vulnerabilities are discovered, by
implementing a penetration test solution.
A penetration test, also known as a pen test or ethical hacking, is an authorized simulated cyberattack on a
computer system, performed to evaluate the security of the system to check for exploitable vulnerabilities,
to determine whether and how a malicious user can gain unauthorized access to assets that affect the
fundamental security of the system, files, logs, and SAWS data.
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 2 of 16

Template: Specifications / Terms of Reference Annexure H
The key benefits expected by SAWS from the proposed manual Penetration Testing solution include but are
not limited to the following:
Reveal vulnerabilities - A report informing IT of security vulnerabilities so it is known what software and
hardware improvements must be considered or what recommendations and policies would improve
overall security.
Protection of sensitive data - Accessing sensitive data and executing operating system commands.
Testing Cyber-defense capability - Ability to detect attacks beforehand and prepare adequate response
on time.
Continuous security testing for systems and operations - proactively find, fix, and verify exploitable
attack paths resulting from weak credentials, misconfigurations, and vulnerabilities speedily.
Scalability - Conduct penetration testing much faster than traditional manual testing, allowing for
quicker remediation of vulnerabilities.
Following regulations and certifications - Industry and legal compliance requirements dictate a certain
...
The contract will be effective for 12 months with 2 x bi-annual manual Penetration Testing Solution. The
second assessment may be threat-led based on first findings
The project objectives are to identify security gaps, improve resilience, ensuring compliance as well as to test
the effectiveness of security controls, and validating security procedures. etc. The business requirement is to
conduct penetration and vulnerability assessments tests bi-annually.
Penetration testing must include manual exploitation techniques in addition to automated vulnerability
scanning.
Automated tools may be used for reconnaissance and scanning; however, validation and exploitation of high
and critical findings must be performed manually.
Submissions based solely on automated vulnerability scanning without manual exploitation will not be
accepted
...
d) Cloud Security Assessment
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 4 of 16

Template: Specifications / Terms of Reference Annexure H
Cloud-hosted services (e.g., Azure, AWS)
Identity and access management in the cloud
Data storage and encryption practices
e) Social Engineering (Optional: only executed with written approval)
Phishing simulations
Employee awareness testing
Physical access attempts (if in scope)
f) Wireless Network Testing
Detection of rogue access points
Encryption and authentication mechanisms
Signal leakage and segmentation
g) Methodology
How will you ensure the completion of vulnerability assessment and penetration testing assessments.
Penetration Testing Framework: Bidder to provide a well-established testing framework, or a
customized approach.
Attack Vectors: Bidder to define the types of attacks to be simulated, such as web application
attacks, network attacks, social engineering, or physical security tests.
Testing Techniques: Bidder to specify the tools, techniques, and procedures that will be used
during the test.
Reconnaissance: Information gathering on target systems
Scanning: Identifying open ports, services, and vulnerabilities
Exploitation: Attempting to exploit identified vulnerabilities
Post-Exploitation: Assessing the impact and persistence mechanisms
Reporting: Documenting findings, risk levels, and remediation steps
h) Deliverables
Penetration Testing Report: Detailed findings, risk ratings, and remediation recommendations
Executive Summary: High-level overview for management
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 5 of 16

Template: Specifications / Terms of Reference Annexure H
Technical Appendix: Tools used, standards (e.g., ISO/IEC 27001, NIST), test cases, and evidence
Remediation Validation Report (if retesting is included)
The contract must include one (1) remediation validation / retest cycle per assessment at no
additional cost, limited to previously identified high and critical findings.
Pentest report must include a detailed attack path
i) Project Plan:
Project plan showing dependencies for completion of the completion of vulnerability assessment and
penetration testing assessments.
j) Meetings and Reporting
Report is to be presented to SAWS (executive and technical reports). Report to include but not limited to the
below:
1. Mapping to MITRE ATT&CK
2. CVSS scoring
3. Business impact per finding
4. Prioritised remediation roadmap (30 / 60 / 90 days)
...
Retest / validation results (where applicable)
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 6 of 16

Template: Specifications / Terms of Reference Annexure H
k) Scope Assumptions Section
The following information will be provided to the successful bidder during project initiation:
Estimated number of IP addresses
List of in-scope applications and environments
Cloud environments and subscriptions
Critical systems classification
Pricing must be based on reasonable industry assumptions and clearly documented.
Final in-scope asset quantities will be confirmed during project initiation. Bidders must clearly state the
assumptions used in their pricing
5 PROPOSED PRICING SCHEDULE AS PER SCOPE OF WORK (Service providers to complete the table in the
attached pricing schedule - Annexure G).
No DESCRIPTION UOM QTY Unit Price (excl. VAT) Total Price (excl. VAT)
1 Vulnerability assessment and Each (bi-
2
penetration testing assessments. annually)
2 Project Management Hourly
1
Rate
Sub Total (Excluding
VAT)
...
VAT)
NB: The contract will be effective for a period of 12 months. Bidders who fail to complete the pricing schedule will be
disqualified.
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 7 of 16
...
6.1 Phase 1: SCM Compliance Requirements
Bids received will be verified for completeness and correctness. SAWS reserves the right to accept or reject a
bid based on the completeness and correctness of the documentation and information provided.
Bidders are to ensure that they submit the following documentation/information with their bid.
Document Comments
Proof of registration on the Central Supplier Bidders must be registered on the CSD. CSD registration
Database (CSD) of National Treasury number must be provided.
Bid Invitation (Annexure A) Completed and signed
Completed
Bidders must note that the non-submission or submission
SBD 3.3 for services (Pricing Schedule)
of incomplete Pricing Schedule (Annexure G) will result in
the disqualification of a bidder.
SBD 4 ( Declaration) Completed and signed
Completed and signed if points are claimed
(A valid B-BBEE certificate, sworn affidavit, or relevant
SBD 6.1 (Preference Points Claim Form)
supporting documentation will be used to claim specific
goals.)
...
The following mandatory requirements must be complied with by the bidder. Please note that bidders will
not be evaluated further if they do not provide evidence confirming compliance with any of the specified
mandatory requirements.
# Mandatory requirement Evidence to be submitted with bid
TEAM QUALIFICATIONS/CERTIFICATES:
Minimum two (2) certificates are required in Copies of Certificates/qualifications.
the event one (1) team member is proposed.
Any of the certificates 1 5 are required 1. CISM
from each team member in the event more
2. CISSP
than one (1) team member is proposed.
3. CEH/EHE
4. OSCP
1) CISM (Certified Information Security
5. CompTIA (Security+)
Manager)
2) CISSP (Certified Information Systems
Security Professional)
3) Ethical Hacking (CEH/EHE) Certified
Ethical Hacker/ Ethical Hacker Essentials
4) OSCP (Offensive Security Certified
Professional)
5) CompTIA (Security+)
Additional relevant industry certifications
will be scored during functional evaluation.
CONTACTABLE REFERENCES
Bidder to provide reference letters (on
ulnerability
assessment and penetration testing
assessments supplied by the bidder.
Reference letters must not be older than 5 Minimum of 3 reference letters not older than 5
years and must include the following: years
Name of the Client of the bidder.
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 9 of 16

Template: Specifications / Terms of Reference Annexure H
Contact the person with contact details.
Brief description of vulnerability
assessment and penetration testing
assessments services rendered by the
bidder to the client.
The reference letter must be dated and
signed by the client.
SAWS reserve the right to contact the
references and verify the information
provided.
Bidders must provide evidence (as requested) of requirements. Bidders that fail to demonstrate compliance
with any of the mandatory requirements under phase 2 will not be considered for further evaluation on
phase 3 and phase 4.
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 10 of 16

Template: Specifications / Terms of Reference Annexure H
6.3 Phase 3: Functional evaluation
Functional evaluation of the bid will be done in terms of the criteria as stated in the table below.
Bidders should take note of the Criterion, Weighting & Scoring when responding to this bid.
Criterion Weight Score
EXPERIENCE OF BIDDERS RESOURCES
A) Engineers / Technical Team Members
1
20 = Above 4 years
15 = 3 4 years
Experience of team members at least two (2) 40
0 = Less than 3 years
1 ICT security team members (max 40 points).
B) Engineers / Technical Team Members
2
Supporting Document: CV of ICT security team
40 = Above 4 years
members.
15 = 3 4 years
0 = Less than 3 years
REPORTING QUALITY & RISK MANAGEMENT
Sub-Criterion Points
Executive & Management
5
Reporting
Technical Depth & Evidence 5
2 Please see Annexure H1 for a guide of scoring
Risk Rating & Business
criteria 20 5
Impact
Remediation & Risk
5
...
Template: Specifications / Terms of Reference Annexure H
PROJECT METHODOLOGY AND PROJECT
PLAN
Project methodology comprised of the below.
How will the service provider execute the
above-mentioned tasks. 0 = No project methodology or project
plan or Project plan and project
3 Project methodology: How will you 30 methodology not in line with scope
ensure the completion of vulnerability of work.
assessment and penetration testing
assessments. 30 = Project Plan and Project
Methodology in line with the scope
Project Plan: Project plan showing of work.
dependencies for completion of the
completion of vulnerability assessment
and penetration testing assessments.
INNOVATION / VALUE ADDS REQUIREMENT
Bidders may propose optional Innovation and
Value-Added services that enhance the
effectiveness, usability, or sustainability of the
4 penetration testing outcomes.
10 = Clear, well-defined innovations that
Innovation proposals must be directly related significantly enhance visibility,
remediation, or skills transfer
to penetration testing, vulnerability
management, remediation effectiveness, or
10
6 = Relevant, practical value adds aligned
cyber-risk decision support.
to SAWS environment
Innovation must:
3 = Minor value adds with limited
Be directly applicable
practical impact
environment
0 = No innovation or value adds
Be deliverable within the contract period
proposed
Not introduce vendor lock-in
TOTAL 100
Bidders who score 70 and more out of 100 will qualify for further evaluation in terms of Phase 4, (Price
and Specific Goals).
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 12 of 16

Template: Specifications / Terms of Reference Annexure H
6.4 Phase 4: PRICE AND SPECIFIC GOALS EVALUATION
...
7 DUE DILIGENCE
The South African Weather Service reserves the right to conduct supplier due diligence prior to final award
or at any time during the contract period. This may include site visits, reference checks and requests for
...
8.1 Delivery
The appointed service provider will be required to render the services to SAWS at the following address:
South African Weather Service
1263 Heuwel Road
Centurion Central
0157
...
Template: Specifications / Terms of Reference Annexure H
ANNEXURE H1
A. Executive & Management Reporting (5 points)
Score Description
5 Clear executive summary with business-focused risk statements and prioritisation
3 Executive summary provided but mostly technical
1 Minimal summary, difficult for management
0 No executive reporting
B. Technical Depth & Evidence (5 points)
Score Description
5 Detailed findings with attack paths, screenshots, logs, and reproducible evidence
3 Findings described but limited evidence
1 High-level vulnerability lists only
0 No demonstrable technical depth
C. Risk Rating & Business Impact (5 points)
Score Description
5 Uses recognised risk models (e.g., CVSS) and links findings to business impact
3 Risk ratings provided but limited business context
1 Generic high/medium/low with no justification
0 No risk rating methodology
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 15 of 16

Template: Specifications / Terms of Reference Annexure H
D. Remediation & Risk Management (5 points)
Score Description
5 Clear remediation guidance, prioritised roadmap, and retesting approach
3 Remediation guidance provided but not prioritised
1 Generic mitigation advice
0 No remediation guidance
Public Document: Document Template Reference: SCM-DEM-QAP-TEMP-4.6
Page 16 of 16
