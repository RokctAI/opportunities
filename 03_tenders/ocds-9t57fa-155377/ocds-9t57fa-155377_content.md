...
RFQ NUMBER: CO0022604RFQ00000004
CLOSING DATE: Date: 22-May-2026
Time: 11:00
DESCRIPTION THE APPOINTMENT OF A QUALIFIED AND EXPERIENCED
SERVICE PROVIDER FOR THE PROVISION OF CHIEF RISK
MANAGEMENT SERVICES ON A RETAINER BASIS,
MANAGING THE ARC’S RISK MANAGEMENT PORTFOLIO.
ADDRESS CO - Central Office
ARC-CO 1134 Park Street, Hatfield
Pretoria
ENQUIRY If you have any enquiries, please email Mavis at
scmrequests@arc.agric.za
SUBMISSIONS SHOULD BE SENT TO scmrequests@arc.agric.za
1. You are kindly requested to submit a written quotation to the Agricultural Research Council as per the attached terms
of reference (TOR) below or attached.
Description
Quantity Unit of Measure
THE APPOINTMENT OF A QUALIFIED AND
EXPERIENCED SERVICE PROVIDER FOR THE
PROVISION OF CHIEF RISK MANAGEMENT SERVICES
ON A RETAINER BASIS, MANAGING THE ARC’S RISK
...
2.2. Only bidders that claim specific goals will be considered for scoring on the 20 points as per the 80/20 principle.
2.3. Completed and signed Standard Bidding Documents (SBD) forms included in the bid document.
2.4. Submission should be sent to scmrequests@arc.agric.za
3. The above specified goods/services should be delivered / rendered to the ARC- Institute at above-mentioned delivery
address.
4. The particulars of the guarantee that will apply to the goods quoted for, with the particular regards to the period and
...
6. All price quotations that have a rand value of R 2,000.00 to below R 50,000,000.00, including VAT, will be evaluated
by applying the 80/20 principle as prescribed by the Preferential Procurement Policy Framework Act 5 of 2022 and
its Regulations.
7. The lowest acceptable price will score 80 points, Specific goals for the tender and points claimed are indicate per
the table below:
...
8.7. Goods and services should be supplied / rendered upon receipt of a purchase order from the ARC.
...
1.1 The following preference point systems are applicable to invitations to tender: the 80/20
system for requirements with a Rand value of up to R50 000 000 (all applicable taxes
included); and
...
GOALS
1.1 Failure on the part of a tenderer to submit proof or documentation required in terms of this tender to claim points
for specific goals with the tender, will be interpreted to mean that preference points for specific goals are not
claimed.
1.2 The organ of state reserves the right to require of a tenderer, either before a tender is adjudicated or at any time
...
3.1. FORMULAE FOR DISPOSAL OR LEASING OF STATE ASSETS AND INCOME GENERATING PROCUREMENT
...
has been applied; and (e) forward the matter for criminal prosecution, if deemed necessary.
...
SUPPLY CHAIN MANAGEMENT SYSTEM SHOULD THIS DECLARATION PROVE TO BE
