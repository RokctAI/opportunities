...
DATE OF ISSUE: 04 MAY 2026
YOU ARE HEREBY INVITED TO BID FOR THE REQUIREMENTS OF NATIONAL FILM AND
VIDEO FOUNDATION
RFP REFERENCE NUMBER: RFP01 2026-2027
CLOSING DATE: 25 MAY 2026
CLOSING TIME: 11:00
RFP VALIDITY PERIOD: 120 DAYS
DESCRIPTION: APPOINTMENT OF A SERVICE PROVIDER TO PROVIDE INTERNET
LINES AND VOICE SOLUTION SERVICES, AND SUPPORT FOR A
PERIOD OF 36 MONTHS.
...
ICASA license Bidders are required to provide an ICASA
license for provision of telephones
...
FOUNDATION
BID NUMBER: RFP01 2026-2027 CLOSING DATE: 25 MAY 2026 CLOSING TIME: 11:00
DESCRIPTION: APPOINTMENT OF A SERVICE PROVIDER TO PROVIDE INTERNET LINES AND VOICE
SOLUTION SERVICES, AND SUPPORT FOR A PERIOD OF 36 MONTHS.
...
3 Validity Period
3.1 Responses to this RFP received from suppliers will be valid for a period of 120 days counted from
the closing date of the tender.
4 Submission of RFP
4.1 The proposals received by the deadline of 25 May 2026 at 11h00 will be reviewed by the NFVF and
shortlist of qualifying service providers will be compiled.
...
5. In bids where Consortia / Joint Ventures / Sub-contractors are involved; each party must submit a
...
Culture, established under the National Film and Video Foundation Act, No. 73 of 1997. Its mandate is
to promote and support the equitable growth of South Africa’s film and video industry through funding,
training, research, and industry development.
To effectively deliver on its mandate, the NFVF relies on robust and reliable ICT infrastructure, including
Internet connectivity and telephony services. The current contract for the maintenance and support of
these services is nearing expiration. As part of its ICT enhancement strategy, the NFVF seeks to appoint
a qualified service provider to deliver upgraded Internet lines and voice solution services, along with
comprehensive support for a period of 36 months.
2. BUSINESS NEEDS
The NFVF requires high-speed, stable Internet connectivity and a modern, scalable voice solution to
support its operational, communication, and collaboration needs. The new solution must ensure seamless
integration with existing ICT systems, provide redundancy, and support remote and hybrid work
environments.
3. OBJECTIVES
To appoint a service provider capable of delivering and supporting upgraded Internet lines and a voice
solution that meets NFVF’s performance, security, and scalability requirements over a 36-month period.
4. SCOPE OF WORK
The appointed service provider will be responsible for:
• Provisioning and installation of high-speed Internet lines with redundancy and failover
capabilities.
• Deployment of a modern voice solution (VoIP or equivalent) compatible with NFVF’s existing
infrastructure.
• Configuration and integration of services with NFVF’s ICT systems.
• Ongoing maintenance and technical support for both Internet and voice services.
• Monitoring and reporting on service performance and uptime.
• Providing user training and documentation.
• Ensuring compliance with data protection and cybersecurity standards.

5. NFVF ICT Environment:
The National Film and Video Foundation has a Hybrid Microsoft Environment, with Applications and
Systems implemented both on on-premises and Cloud.
a) The NFVF has about 60 users set up on a Microsoft E3 Platform
• Fortinet Firewall (100E) x1
• Dell PowerEdge R740xd Host Server (Running VMWare 6.7) x2
• Fortinet Switches (Core switches) x3
• Fortinet Access Points x7
• Windows Server 2016 Virtual Servers x 7
• DFS Server x1
• Application Server x1
• Backup Server x1
• AD, DHCP & DNS Server x1
• Secondary AD x1
b) The NFVF has two internet connection lines:
• A 100Mbps fiber broadband connection.
• A 20Mbps redundancy line (WIRELESS).
c) The NFVF has in place:
• Smart executive Reception\Switchboard IP Phone (Yealink T448S or Equivalent) x1.
• Hosted HoduPhone for Voice Solution service.
6. REQUIRED SERVICES
• 100Mbps dedicated 1:1 Contention Ratio business enterprise Fibre line, uncapped, unshaped
• 20Mbps redundancy line (WIRELESS),
• Smart executive Reception\Switchboard IP Phone (Yealink T448S or Equivalent) x1
• Voice Solution (Hosted 3CX Solution)
7. SYSTEM TECHNICAL SUPPORT
• The Vendor or Supplier should ensure 24/7 support, with a combination of onsite, phone, and
digital help desk protocols.
• The local support technicians should either be employees of the vendor or employees of a
third-party support group. The vendor company should fully support the system.
• The vendor or supplier should provide a platform dedicated to the ongoing support of the
system.

• The vendor should have escalation policies and procedures for system problems, issues, and
"bugs."
...
NB: NFVF reserves the right to call for presentations to clarify supplier capability should the need arise.
Should Presentations be required bidders will be assessed on the following areas but not limited to:
customer service,(responsiveness, support channels etc), cost (monthly pricing, installation set up fees etc,
reliability (uptime and downtime, outage handling).
...
• Bidders are required to provide an ICASA license for provision of telephones (This requirement is
compulsory and failure to provide the license will lead to total disqualification)
...
will be verified through the CSD. Bidders tax status must be in order in line with Treasury Regulations
and must reflect on CSD.
• Completed and signed Standard Bidding Documents attached to the bid. In case of a Joint Venture, a
written agreement between the parties which must clearly set out the roles and responsibilities of each
member.
...
• Certified copy of B-BBEE Certificate. A Joint Venture will qualify for the B-BBEE status level as a legal
entity, provided that the legal entity submits their B-BBEE status level certificate. Failure on the part of
the bidder to comply with the above will be deemed that preference points for B-BBEE status level of
contribution are not claimed and will therefore be allocated a zero (0).

8.2. Stage 2: Functionality Evaluation
Bidders who provide all required administration documents will be evaluated on functionality. The
threshold points to qualify for technical evaluation is 75 points. Bidders who score an overall score of
75 points or above will be evaluated on the next stage of evaluation (price and specific goals) and
bidders who score below will be disqualified from the evaluation process.
...
Project Implementation Plan - Bidders are to provide a detailed project 25 Points
Technical Installation to be implementation plan based on the
completed within 3 Weeks. timelines provided of 3-weeks. The
implementation plan should include the
following:
(a) All tasks and activities – (0-10
points)
(b) Resources – (0-5 points)
(c) Milestones and contingency plan to
manage milestones (0-10 points)

Experience of the Project The bidder must provide a CV that will 15 Points
Leader on similar project. be used as evidence to substantiate the
number of years of experience on
similar projects. If no proof of years of
experience can be obtained from the
CV provided, bidders will not be
allocated points.
(a) Less than 3 years = 0 points
(b) 3 to 4 years = 5 points
(c) 5 to 6 years = 10 points
(d) 7 years and above = 15 points
Service Approach Bidders must provide full details of the 40 Points
proposed installation for the provision of
Internet and Voice Solution Services for
NFVF.
• Provide a detailed plan on the Internet
line and connection of the failover line in
case the primary line is disrupted – (0 -
15 points)
• Provide a detailed work plan on how to
take over the current services from the
current service provider without
affecting operations – (0- 15 points)
• Proposed Quality Assurance Approach
(i.e.: Testing, bandwidth quality, latency,
jitter, customer service etc.) – (0- 10
points)
Bidder’s experience in The Bidder must demonstrate that they 20 Points
providing similar services have the capacity to render the required
service. The Bidder must provide
references from the public or related
institutions where similar service were

rendered. The reference letter must be
on the letterhead of the previously
serviced client, and should reflect at
least name of the client, description of
the relevant services rendered, year
completed, contactable reference name
and contact details and whether the
quality of work was satisfactory or not. It
should be signed by a duly authorised
person or their representative. The
reference letter should be within the last
five years. Reference Letters
(a) 2 and less reference letters = 05
points
(b) 3 reference letters = 10 points
(c) 4 reference letters = 15 points
(d) 5 reference letters = 20 points
(e) 6 and above reference letters = 25
points
NOTE: NFVF may verify the information
provided, and if your referee does not
confirm the information provided, the
...
27. Notices
28. Taxes and duties
29. National Industrial Participation Programme (NIPP)
Page 40 of 50
...
18. Delays in the service provider’s performance
...
Services.
29. National Industrial Participation (NIP) Programme
