...
1.1 Item 1: appointment of service provider to assist with once off gate repair at George office, as per the annexure H
requirements.
...
Repairing Office gate at George Weather Office
...
– Annexure H
1 DESCRIPTION
Appointment of service provider for the repair and fitting of the existing Office gate at George Weather
office.
2 INTRODUCTION
...
3 BACKGROUND
The Office gate cannot open or close anymore due to the bottom bar being rusted and this might pose a
security threat and requirs immediate attention for necessary repair so that the access can be controllable on
who come in and out of the office
4 REQUIREMENT / SCOPE OF WORK
Successful service provider will be expected to provide the following;
Item description Repair of existing Office gate (bottom bar)
Quantity required 1
Technical specification Supply and replace bottom rectangular tubing 38x76x4m (must be galvanized)
Install new wheels
Supply and Paint gate (grey) (Paint must be NS4 anti-rust primer grey)
Set gate tracks
All this can be done at Office
Dimension Size of gate
4.3m length
1.93 height
Public Document: Document Template Reference: CFO-SCM-TEMP-002
Page 2 of 5
...
Template: RFQ Terms of Reference for services
– Annexure H
Just take note that we are not replacing the whole gate, only the bottom bar as
per the above
5 EVALUATION OF BIDS
The RFQ will be evaluated in 3 phases as mentioned below:
➢ Phase 1: SCM Administrative Requirements.
➢ Phase 2: Mandatory Requirements.
➢ Phase 3: Price and Specific Goals.
5.1 Phase 1: SCM Administrative Requirements
...
affidavit, or relevant supporting
documentation will be used to claim
specific goals.)
...
1 Bidder must attend a compulsory site briefing The bidder is required to attend the
mandatory on-site briefing session at George
office and must complete and sign the official
attendance register during the session.
2 The bidder must be in good standing with the Bidder must provide a Valid Letter of good
Department of Labor standing from Workman’s Compensation
(COIDA)
3 Reference letter Bidders must provide SAWS with contactable
reference whom SAWS may contact to
Bidders must have completed welding work ascertain the service carried out with previous
with previous clients clients. The reference must have the
following:
• Name of the corporate client
• Contact person with contact details (email
and telephone number)
• Brief description of service/s rendered by
the bidder
Reference letter must be dated and signed by
the client
4 Project plan Bidders must provide SAWS with project plan
for the service with the following:
Timeline on commencement and completion
5.3 Phase 3: Price and Specific Goals
