1. Price quoted must be firm (for the duration of the contract) and inclusive of VAT (if applicable)
2. All MBD forms MUST be completed and signed.
...
6. Registration summary must be attached as a proof that the bidder is registered with Central
Suppliers Database (CSD)
1. A firm delivery period must be indicated.
2. Copies from certified copies are not allowed.
3. When documents certification is done by the commissioner of oath, ensure that the date of
...
3. This bid will be evaluated in terms of the 80/20 preference point system as prescribed by
PPPFA regulations implemented on the April 2017,
...
2. Background
3. Project Specifaction
4. Pricing
5. Bid Evaluation
5.1 Evaluation Process
5.2 Weighting Factor
1. Purpose of the tender
The puropse is to call for qualified bidders for the instalation and maintenance of tracking system for
municipal vehicles of Greater Taung Local Municipality on a Three year (3) contract.
1. Background
The current vehicle tracking companys contract expired, hence the need to appoint a quilified tracking
company, to render tracking services on a 5 year contract.
1. Project Specifaction
The successful vehicle tracking company needs to deliver and install tracking devices with suitable
equipments/devices in Council vehicles, which must have aleast the following features:
3.1. GENERAL
a) The tracking unit must provide features like real time vehicle monitoring and vehicle history from point of
installation.
b) Must provide all the software & hardware literature and brochures for free after installation of the tracking
system.
c) Number of vehicles (57)
3.2. APPLICATION
a) The unit must sends data to the web platform indicating whether it is in motion or stationary and can be
tracked in real time
b) The unit should receive various signals that it transmits to the web based platform that requires a username
and password.
c) The unit must be suitable for all terrains and can operate at temperatures ranging -25°C to +60°C.
d) The system should be 100% web based thus requires no software installation into your computer.
Manuals in both hard and soft copies are available.
e) Should have different user accounts i.e. where company create accounts and give certain authorities
including immobilizing the vehicle if authorized, can immobilize the vehicle using the web based platform or
sms.
f) The unit should supplied with the latest firmware with our specifications.
3.3. DESCRIPTION OF THE UNIT
a) The unit must be tamper proof, must have no visible switch and must be hidden within the vehicle.
b) The unit must have an appropriate fuse and a surge protector (12volts-24 volts).
c) The unit should integrate into existing vehicle alarms and other tracking units.
d) The unit’s antenna must be strong enough to pick very weak signals.
e) The GPS sensitivity must be -159dbm and the GPS module supports 20 channels
f) The Gprs data transmission capacity must be 85.6 kbps

g) Built-in battery to power the unit that ensures continued storage and tracking data must be sent to the web
platform when main power is disconnected.
h) Data backup. When the unit goes offline (in case there is no internet connection in the country), data must
be stored into the device’s inbuilt memory and uploaded to servers once connectivity resumes.
i) The system should have a GSM module 850/900/1800/1900Mhz
j) The unit should support both sms/ missed call position reply including posting speed and other vehicle
information.
k) The tracking system must not interfere with the operations of the vehicle.
l) When the vehicle is in motion, it must be visible in the live tracking
m) The unit should have sleep mode and that can be preset to different modes e.g. upload data when there is no
speed, which means the unit will not send data as long as the vehicle is moving.
N) Incident reporting alerts to be reported within 24 hours.
3.4. GPS (GLOBAL POSITION SYSTEM)
a) Data backup feature should provides replay of offline route using Google maps
b) Have a web based platform using up to date Google maps that gives real time vehicle location and status
which can be accessed using an internet enabled phone or computer.
c) The frequency of transmission must not be based on time, distance and angle but settings by the
administrator of the system who can choose to customize transmission intervals e.g. 1 minute, 5 minutes.
d) The location accuracy is 5-10 meters
e) The web based platform must be in real time and gives vehicle information when in motion, when on or
when off.
f) Coverage is configured to use gprs.
g) The system must have geo-fencing/route creation capabilities and it must triggers alerts when the vehicle
goes out of an authorized area.
3.5. SOFTWARE
a) System must be 100% web based
b) Data export to excel/pdf is available on the system.
c) The system must be hosted on secure servers to allow data security, backup and recovery.
d) The system must have several alerts which include; over speeding, low battery, multiple geo fences,
disconnection from main power source.
e) The system must have keys/fields including Reg no, colour, make, driver name etc.
f) The system must allows one to view multiple vehicles in real time. They must be distinguished by the
vehicle info displayed against the icons on the map including location and speed.
g) The unit/system must allow authorized users to immobilize the vehicle using their user names or authorized
cell phone numbers.

3.6. STANDARD REPORTS
a) The system must processes detailed reports on ;
-Fleet status,
-Fleet location,
-Distance,
-Start/stop,
...
c) Driver ID (Driver Tag indicating driver name and Surname on report)
d) Panic alert botton.
3.7. WARRANTY AND SERVICE CONTRACT
a) The warranty period is 3 years.
b) Warranty replacement is done for parts that fail early.
c) For support services, tracking personnel must be available on call 24/7 and they must assist in locating,
monitoring and vehicle immobilization and mobilization. They must also do recovery.
i) The maximum response time to reported defects must be within 24 hours.
ii) The system’s reliability must be a commendable 97%.
iii) Must holds full responsibility for installation and maintenance of
...
b) System must be web based and can be accessed from anywhere with an internet enabled phone or
computer.
c) Training to be offered on both functional and technical aspects of the system.
d) The system must performs silent upgrades and diagnosis is done by supplier
e) Driver Tags
3.9. DEMO
...
and month).
d) Fuel monitoring by quantity, mileage and consumption must be incorporated. However
this must comes with an additional cost and must use fuel sensors and not tapping the voltage.
e) The system must use Google Maps
3.10. OTHER FUNCTIONAL FEATURES
...
1. Pricing
Description Quantity Unit Total Total 2nd Year Total 3rd Year
price 1st (6% increase) (6% increase)
Year
Trcking device 1
per unit per
(Monthy
...
The 80/20 Principle will be applied in terms of the preference procurement policy framework.
Price : 80 Points
Preference : 20 Points
Functionality
The following criteria will be used in particular as the criteria for appointment, apart from
those laid down in the preferential regulations, 2001 pertaining to the preferential
procurement policy framework Act 5 of 2000.
NO Critera Weight
1 Relevent experience in terms of installation of 50
tracking systems (Please attach Appointment letters
and referance letters from government instations)
5 and above appointment letters 50
3-4 Appointment letters 35
1-2 Appointment letters 10
2 Professional Status of company 35
Tracking device and vehicle recovery plan (attach
recover plan)
3 List of Qualified personnel with at least PSIRA 15
certificates Please attach CV’s and proof of
certified qualifications and certified ID copy’s
Three qualified personal 10
Two to one qualified personal 5
Bidders Who Fail To Score More Than 70 Points on Functionality Will Be Considered As
Submitting A Non-Responsive Bid, And Will Not Be Considered For Further Evaluation.

GREATER TAUNG LOCAL MUNICIPALITY: SUPPLY CHAIN
MANAGEMENT UNIT
TENDER FOR THE APPOINTMENT OF A SERVICE PROVIDER FOR THE
INSTTALLATION AND MAINTENANCE OF VEHICLE TRACKING SYSTEM
FOR THE PERIOD OF THREE YEARS
SPECIFICATION AND ADDITIONAL CONDITIONS OF TENDER
PURPOSE
The purpose of this bid is to seek a service provide/s for INSTTALLATION AND MAINTENANCE
OF VEHICLE TRACKING SYSTEM FOR THE PERIOD OF THREE YEARS.
...
BID NUMBER: GTLM/INFR03/2026/2027 CLOSING DATE: 29 SEPTEMBER 2026 CLOSING TIME: 12H00
INSTTALLATION AND MAINTENANCE OF VEHICLE TRACKING SYSTEM FOR THE PERIOD OF
...
Name of Bidder…………………………………… Bid Number: GTLM/INFR03/2026/2027
...
TENDER OFFER
APPOINTMENT: INSTTALLATION AND MAINTENANCE OF VEHICLE TRACKING
SYSTEM FOR THE PERIOD OF THREE YEARS
Bid No: GTLM/INFR03/2026/2027
Closing Date: 29 SEPTEMBER 2026
...
GTLM/INFR03/2026/2027: INSTTALLATION AND MAINTENANCE OF VEHICLE TRACKING SYSTEM FOR THE PERIOD OF
THREE YEARS
